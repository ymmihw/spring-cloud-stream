...
import com.ymmihw.spring.cloud.stream.MultipleOutputsWithConditionsServiceApplication;
...
public class MultipleOutputsWithConditionsServiceIntegrationTest {
  ...
  public void whenSendMessage_thenResponseIsInAOutput() {
    whenSendMessage(1);
    thenPayloadInChannelIs(pipe.anOutput(), String.valueOf(1));
  }

  @Test
  public void whenSendMessage_thenResponseIsInAnotherOutput() {
    whenSendMessage(11);
    thenPayloadInChannelIs(pipe.anotherOutput(), String.valueOf(11));
  }
